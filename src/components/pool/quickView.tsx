	...
	if (item) {
		return (
			...
			>
				...
				<div className="pool-item-amount">{formatUSD.format(contributionInUSD)}</div>
...
export const PoolAccounts = (props: { legacy: boolean }) => {
	...
	return (
		<>
			...
			<ConfigProvider
				renderEmpty={() => <Empty image={Empty.PRESENTED_IMAGE_SIMPLE} description={t`No liquidity found.`} />}
			>
